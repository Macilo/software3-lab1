...
const softwareStudents = students.filter(student => student.electives.findIndex(elective => elective !== electiveOne) && student.yearOfStudy === 4)
// const result = softwareStudents.filter(student => student.yearOfStudy === 4)
// console.log(result)
